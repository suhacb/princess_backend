...
return [
    ...
    'info' => [
        ...
        'description' => <<<'MD'
        # Princess Backend API

        Backend API for the Princess PRINCE2 project management platform.
        ...
        | Header | Description |
        |---|---|
        | `Authorization: Bearer <token>` | Keycloak access token |
        | `X-Refresh-Token` | Keycloak refresh token |
        | `X-Application-Name` | Calling application name |
        | `X-Client-Url` | Calling application base URL |

        Tokens are obtained from the auth gateway — see `POST /auth/login` for the redirect flow.
        MD,
    ],

    'ui' => [
        'title' => 'Princess Backend API',
    ],
