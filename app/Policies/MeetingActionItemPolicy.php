...
{
    public function create(User $user, Project $project, Meeting $meeting): bool
    {
        return $meeting->project_id === $project->id
            && $this->memberCan($user, $project, 'meetings:manage');
    }

    public function update(User $user, Project $project, Meeting $meeting, MeetingActionItem $item): bool
    {
        return $meeting->project_id === $project->id
    ...
    public function delete(User $user, Project $project, Meeting $meeting, MeetingActionItem $item): bool
    {
        return $meeting->project_id === $project->id
            && $item->meeting_id === $meeting->id
            && $this->memberCan($user, $project, 'meetings:manage');
